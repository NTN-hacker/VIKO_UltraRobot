...
class VisionRobot:
    ...
    def connectRobot(self) -> None:
        ...
        if RUN_ON_ROBOT:
            ...
            self.robot.Connect("192.168.10.102")  # Try to connect once (Or 192.168.10.102)
            self.robot.ConnectSafe("192.168.10.102")  # Try to connect multiple times (Or 192.168.10.102)
