...
class BaslerGuiWindow(wx.Frame):
    ...
    def __init__(self, parent, title, size):
        super(BaslerGuiWindow, self).__init__(parent, title = title, size=size)
        self.InitUI()
    ...
    def InitUI(self):
        ...
        notebook.AddPage(tab1, "Settings")
        notebook.AddPage(tab2, "Inspection")
        ...
        right_panel = wx.Panel(tab2)
        right_sizer = wx.BoxSizer(wx.VERTICAL)
        right_panel.SetMaxSize((800, 600))
...
if __name__ == '__main__':
    app = wx.App()
    ex = BaslerGuiWindow(None, "GUI",  size=(800, 600))
    app.MainLoop()
